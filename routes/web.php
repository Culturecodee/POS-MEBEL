...
use App\Http\Controllers\Apps\BestProductController;
...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth']], function () {
    ...
    Route::post('/products/catalog-background', [ProductController::class, 'updateCatalogBackground'])
        ->middleware('permission:products-edit')
        ->name('products.catalog-background.update');
    ...
    // best products report
    Route::get('/restock', [BestProductController::class, 'index'])->middleware('permission:reports-access')->name('restock.index');
    Route::post('/restock/validate', [BestProductController::class, 'validateData'])->middleware('permission:reports-access')->name('restock.validate');
    Route::post('/restock/calculate', [BestProductController::class, 'calculate'])->middleware('permission:reports-access')->name('restock.calculate');
