...
class SalesReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $soldItems = $transactionIds->isNotEmpty()
            ? TransactionDetail::query()
                ...
                ->select(
                    ...
                    DB::raw('COALESCE(products.title, "Produk dihapus") as title'),
                    DB::raw('SUM(transaction_details.qty) as total_qty'),
                    DB::raw('SUM(transaction_details.qty * transaction_details.price) as total_amount')
                )
