...
class PaymentSettingController extends Controller
{
    public function edit()
    {
        ...
        return Inertia::render('Dashboard/Settings/Payment', [
            ...
            'supportedGateways' => [
                ...
                ['value' => PaymentSetting::GATEWAY_WHATSAPP, 'label' => 'Kirim ke WhatsApp'],
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            'default_gateway' => [
                'required',
                Rule::in(['cash', PaymentSetting::GATEWAY_WHATSAPP, PaymentSetting::GATEWAY_MIDTRANS, PaymentSetting::GATEWAY_XENDIT]),
            ],
        ...
        if ($data['default_gateway'] === PaymentSetting::GATEWAY_WHATSAPP && empty($data['whatsapp_company_number'])) {
            return back()->withErrors([
                'whatsapp_company_number' => 'Nomor WhatsApp perusahaan wajib diisi jika dijadikan metode default.',
            ])->withInput();
        }

        if (
            $data['default_gateway'] !== 'cash'
            && !(($data['default_gateway'] === PaymentSetting::GATEWAY_WHATSAPP && filled($data['whatsapp_company_number']))
        ...
        $setting->update([
            ...
            'whatsapp_company_number' => $data['whatsapp_company_number'],
