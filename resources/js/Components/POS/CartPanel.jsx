    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-semibold text-[#7b563f] dark:text-[#ead7bf] mt-1">
            ...
            <div className="flex flex-col items-end justify-between">
                ...
                <button
                    ...
                    disabled={isRemoving}
                    className="p-1.5 rounded-lg text-slate-400 hover:text-[#8a4f35] hover:bg-[#f6e8de] dark:hover:bg-[#6a3f2d]/40 transition-colors opacity-0 group-hover:opacity-100"
                >
                    <IconTrash size={16} />
                </button>
    ...
    return (
        <div className={`flex flex-col h-full ${className}`}>
            ...
            <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800">
                ...
                {totalItems > 0 && (
                    <span className="px-2.5 py-0.5 text-xs font-bold bg-[#f3e7d9] text-[#7b563f] dark:bg-[#5f3f2d]/30 dark:text-[#ead7bf] rounded-full">
                        {totalItems} barang
                    </span>
                )}
            </div>
