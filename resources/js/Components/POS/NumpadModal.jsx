        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-slide-up">
                    ...
                    <div className="grid grid-cols-4 gap-2 px-5 py-3 border-b border-slate-100 dark:border-slate-800">
                        {[10000, 20000, 50000, 100000].map((amount) => (
                            <button
                                ...
                                className="py-2 px-2 text-xs font-medium rounded-xl bg-[#fbf4eb] dark:bg-[#5f3f2d]/30 text-[#7b563f] dark:text-[#ead7bf] hover:bg-[#f3e7d9] dark:hover:bg-[#5f3f2d]/50 transition-colors"
                            >
                                +{amount / 1000}rb
                            </button>
                        ))}
                ...
                <div className="p-5 grid grid-cols-3 gap-3">
                    ...
                    <button
                        onClick={handleClear}
                        className="h-14 text-sm font-semibold rounded-2xl bg-[#f6ecdd] dark:bg-[#6f4b36]/40 text-[#8c6141] dark:text-[#e2bd8d] hover:bg-[#efdfcc] dark:hover:bg-[#6f4b36]/60 active:scale-95 transition-all"
                    >
                        C
                    </button>
                ...
                <div className="p-5 pt-0">
                    <button
                        ...
                        className={`w-full h-14 flex items-center justify-center gap-2 text-lg font-semibold rounded-2xl transition-all ${
                            isValid
                                ? "bg-gradient-to-r from-[#7b563f] to-[#5f3f2d] text-white shadow-lg shadow-[#7b563f]/30 hover:shadow-xl active:scale-[0.98]"
