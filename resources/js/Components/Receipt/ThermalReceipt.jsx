...
import { thermalPaymentMethodLabels } from "@/Utils/paymentMethods";
...
export default function ThermalReceipt({
    ...
    const paymentMethod =
        thermalPaymentMethodLabels[transaction?.payment_method?.toLowerCase()] ||
        "TUNAI";
    const isDirectPayment = [
        ...
        "bank_mandiri",
        "bank_bni",
    ].includes((transaction?.payment_method || "cash").toLowerCase());
    ...
    return (
        ...
        >
            ...
            <div className="text-center mt-2">
                <p className="text-xs">
                    Terima Kasih sudah berbelanja di Aisyah Dekorasi Jepara
                </p>
            </div>
...
export function ThermalReceipt58mm({
    ...
    return (
        ...
        >
            ...
            {isDirectPayment && Number(transaction?.change) > 0 && (
                <div className="flex justify-between">
                    <span>Kembali</span>
