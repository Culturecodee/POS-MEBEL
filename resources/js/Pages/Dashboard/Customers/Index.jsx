        ...
        <div className="group bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 hover:shadow-lg hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-200">
            ...
            <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#b68558] to-[#8a5a3c] flex items-center justify-center text-white text-lg font-bold flex-shrink-0">
            ...
            <div className="flex gap-2 pt-3 border-t border-slate-100 dark:border-slate-800">
                <Link
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg bg-[#f5ebdf] text-[#9a6b45] hover:bg-[#ead9c7] dark:bg-[#6f4b36]/30 dark:text-[#e7c9aa] text-sm font-medium transition-colors"
                >
                ...
                <Button
                    ...
                    className={
                        "flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg bg-[#f3e1d7] text-[#8f4f39] hover:bg-[#e7cfbf] dark:bg-[#7a4a2d]/30 dark:text-[#f1d5c7] text-sm font-medium"
                    }
                            ...
                            <Table.Tbody>
                                {customers.data.map((customer, i) => (
                                    ...
                                    >
                                        ...
                                        <Table.Td>
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#b68558] to-[#8a5a3c] flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                                                    {customer.name
                                                        .charAt(0)
                                                        .toUpperCase()}
                                                </div>
