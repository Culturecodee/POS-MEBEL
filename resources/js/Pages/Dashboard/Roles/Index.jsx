        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden hover:shadow-lg transition-all">
            ...
            <div className="p-5 border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#b68558] to-[#8a5a3c] flex items-center justify-center text-white">
            ...
            >
                <form onSubmit={data.isUpdate ? updateRole : saveRole}>
                    ...
                    <Button
                        ...
                        className={
                            "bg-[#8a5a3c] hover:bg-[#6f4b36] text-white w-full justify-center"
                        }
                        label={"Simpan"}
                    />
                </form>
