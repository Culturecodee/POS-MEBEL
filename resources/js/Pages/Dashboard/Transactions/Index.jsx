...
export default function Index({
    ...
    const [paymentMethod, setPaymentMethod] = useState(
        ["cash", ...manualPaymentOptions.map((option) => option.value)].includes(
            defaultPaymentGateway ?? "cash"
        )
            ? defaultPaymentGateway ?? "cash"
            : "cash"
    ...
    useEffect(() => {
        if (auth?.customer && customers.length === 1) {
            setSelectedCustomer(customers[0]);
        }
    }, [auth?.customer, customers]);
    ...
    const handleSubmitTransaction = () => {
        ...
        router.post(
            route("transactions.store"),
            {
                ...
                payment_gateway: paymentMethod === "cash" ? null : paymentMethod,
            },
            {
                onSuccess: () => {
                    setCashInput("");
            ...
            <div className="h-[calc(100vh-4rem)] flex flex-col lg:flex-row">
                ...
                <div className="lg:hidden flex border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                    ...
                    >
                        ...
                        <span>Keranjang</span>
                        {cartCount > 0 && (
                            <span className="absolute top-2 right-1/4 w-5 h-5 flex items-center justify-center text-xs font-bold bg-[#7b563f] text-white rounded-full">
                                {cartCount}
                            </span>
                        )}
                    </button>
                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto min-h-0">
                        ...
                        <div className="p-3 border-b border-slate-200 dark:border-slate-800">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                {carts.length > 0 && (
                                    <span className="px-2 py-0.5 text-xs font-bold bg-[#f3e7d9] text-[#7b563f] dark:bg-[#5f3f2d]/30 dark:text-[#ead7bf] rounded-full">
                                        {cartCount} item
                                    </span>
                                )}
                            </div>
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                <button
                                                    ...
                                                    className="w-6 h-6 rounded flex items-center justify-center text-slate-400 hover:text-[#8a4f35] hover:bg-[#f6e8de] dark:hover:bg-[#6a3f2d]/40 ml-1"
                                                >
                                                    <IconTrash size={12} />
                                                </button>
                                            </div>
                                            <p className="text-xs font-semibold text-[#7b563f] dark:text-[#ead7bf] w-16 text-right">
                    ...
                    <div className="flex-shrink-0 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80 p-3">
                        ...
                        {isDirectPayment &&
                            cash >= payable &&
                            payable > 0 && (
                                <div className="flex justify-between items-center mb-3 p-2 rounded-lg bg-[#fbf4eb] dark:bg-[#5f3f2d]/30">
                                    <span className="text-sm text-[#8c6141] dark:text-[#e2bd8d]">
                                        Kembalian
                                    </span>
                                    <span className="font-bold text-[#8c6141] dark:text-[#e2bd8d]">
            ...
            {showShortcuts && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-6 max-w-sm w-full">
                        ...
                        <button
                            onClick={() => setShowShortcuts(false)}
                            className="mt-6 w-full py-2.5 bg-[#7b563f] hover:bg-[#694733] text-white rounded-xl font-medium"
                        >
                            Tutup
                        </button>
                    </div>
